...
var virus6, virus6IMG, virus7, virus7IMG, virus8, virus8IMG, virus9, virus9IMG;
...
function draw() {
  ...
  if(player.x === 10) {
    fill("blue");
    textSize(25);
    text("Help the player to get out of the maze",75,270);
  }
  ...
  if(player.isTouching(virus1 || virus2 || virus3 || virus4 || virus5 || virus6 || virus7 || virus8 || virus9 || crowd1 || crowd2)) {
    fill("blue");
    textSize(25);
